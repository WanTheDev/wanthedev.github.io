...
export default function GlowingImage({image, radius=0}:{image:string, radius?: string | number}) {
    ...
    return(
        <Container style={{zIndex: 1}} pos="relative">
            <Image left="0" top="0%" h="100%" w="100%" fit="contain" data-blurry pos="absolute" src={image} className={classes.floating}  style={{animationDelay: animDelay+'ms'}}/>
